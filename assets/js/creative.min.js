...
e(),a(window).scroll(e),a("#portfolio").magnificPopup({delegate:"a",type:"image",tLoading:"Loading...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<iframe width="640" height="360" src="%url%" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'}})}(jQuery)
